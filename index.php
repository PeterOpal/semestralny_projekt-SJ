<!-- PHP projekt: cestovná kancelária, Peter Opál -->
<!doctype html>
...
<section class="discount-offer">
    <?php
        $tours->divClassGenerator(["container", "row", "col-sm-12", "dicount-offer-content text-center"]);
    ?>
    <h2>Join with us within 7 August, 2023 and get upto 40% Discount</h2>
